/*
@Author: whiteGloom (Evgeniy Miller)
@Date of publication: 30.06.2019
@GitHub: https://github.com/whiteGloom/wRunner
 */
! function(e) {
    var t = {};
    ...
    92: function(e, t, i) {
                ...
                return t = e, (i = [{
                        ...
                        [this.base, this.outer, this.path, this.pathPassed, this.divisions, this.handle, this.handleMin, this.handleMax, this.valueNote, this.valueNoteMin, this.valueNoteMax].concat(this.divisionsList).forEach((function(t) {
                            for (var i in e) {
                                var n = t.classList[0],
                                    s = e[i].oldValue,
                                    a = e[i].value;
                                s && t.classList.remove(n + "_" + e[i].className + "_" + s), t.classList.add(n + "_" + e[i].className + "_" + a)
                            }
                        }))
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        [this.valueNote, this.valueNoteMin, this.valueNoteMax].forEach((function(t) {
                            var i = t.classList[0];
                            t.classList.remove(i + "_display_" + (e.valueNoteDisplay ? "hidden" : "visible")), t.classList.add(i + "_display_" + (e.valueNoteDisplay ? "visible" : "hidden"))
                        }))
                    }
                }, {
                    key: "generateDivisions",
                    value: function() {
                        this.divisions.innerHTML = "", this.divisionsList.length = 0;
                        for (var e = this.divisionsCount; e > 0; e--) {
                            var t = document.createElement("div");
                            t.classList.add("wrunner__division"), this.divisionsList.push(t), this.divisions.appendChild(t)
                        }
                    }
                }, {
                    key: "setRoots",
                    value: function(e) {
                        if (r.isDOMEl(e)) return this.roots = e, this.rootsUpdateEvent.trigger(this.roots), this.roots
                    }
                }, {
                    key: "setDivisionsCount",
                    value: function(e, t) {
                        if (r.isNumber(e) && !(e < 0)) return 1 === (e = Math.round(+e)) && (e++, t || console.log("Count was increased by one, cause it may not be equal to one.")), this.divisionsCount = +e, this.divisionsCountUpdateEvent.trigger(this.divisionsCount), this.divisionsCount
                    }
                }, {
                    key: "setTheme",
                    value: function(e) {
                    ...
                    key: "_buildBaseDOM",
                    value: function() {
                        this.base.appendChild(this.outer), this.outer.appendChild(this.path), this.path.appendChild(this.pathPassed), this.outer.appendChild(this.divisions)
                    }
                }, {
                    key: "_addEvents",
                    value: function() {
                        this.UIMouseActionEvent = d(), this.rootsUpdateEvent = d(), this.themeUpdateEvent = d(), this.directionUpdateEvent = d(), this.valueNoteDisplayUpdateEvent = d(), this.divisionsCountUpdateEvent = d()
                    }
                }, {
                    key: "_addListenners",
                    value: function() {
                    ...
                    value: function(e) {
                        if (0 === e.button) {
                            var t = !1,
                                ...
                                n = function(e) {
                                    var n = e.target;
                                    document.body.removeEventListener("mousemove", i), t || n !== this.handle && n !== this.handleMin && n !== this.handleMax && i(e)
                                }.bind(this);
                            document.body.addEventListener("mousemove", (function() {
                                return t = !0
                            }), {
                                once: !0
                            }), document.body.addEventListener("mousemove", i), document.body.addEventListener("mouseup", n, {
                                once: !0
                            })
                        }
                    }
        ...
        var c = function() {
            ...
            return t = e, (i = [{
                ...
                value: function(e) {
                    void 0 !== (e = e || {}).type && this.model.setType(e.type), void 0 !== e.limits && this.model.setLimits(e.limits), void 0 !== e.step && this.model.setStep(e.step), void 0 !== e.singleValue && this.model.setSingleValue(e.singleValue), void 0 !== e.rangeValue && this.model.setRangeValue(e.rangeValue), void 0 !== e.roots && this.view.setRoots(e.roots), void 0 !== e.theme && this.view.setTheme(e.theme), void 0 !== e.direction && this.view.setDirection(e.direction), void 0 !== e.divisionsCount && this.view.setDivisionsCount(e.divisionsCount), void 0 !== e.valueNoteDisplay && this.view.setValueNoteDisplay(e.valueNoteDisplay)
                }
            }, {
                key: "_triggerEvents",
                value: function() {
